...
f1 = st.sidebar.number_input('Время, затраченное на этап "Продувка" (сек)', value = 1167)
...
f9 = st.sidebar.number_input("""Время, затраченное на этап "Обрыв горловины" (сек) (если не было, напишите 0)""", value = 138)
